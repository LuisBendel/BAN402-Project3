...
# The file to run and solve is the model.mod file
# All running commands are included in this mod file, so there is no separate .run file
# Note the name of your data file must be given as input in lines 44 or 45 (do not modify other lines in this file; except for if you use Mac and the solver needs to be called as explained in line 36)
#-----------------------------------------------------------------------------
...
#let datafile := "blockbids_3.dat";   # Select the input data file here for question 3 (complete the data file name with 1,2,3,4,5)
